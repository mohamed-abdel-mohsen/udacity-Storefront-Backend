...
var user_model_1 = require("../model/user_model");
var dotenv_1 = __importDefault(require("dotenv"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
dotenv_1["default"].config();
var users = new user_model_1.StoreUser();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var new_user, secToken, new_Employee, token, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                new_user = {
                ...
                secToken = process.env.TOKEN_SECRET;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, users.create(new_user)];
            case 2:
                new_Employee = _a.sent();
                token = jsonwebtoken_1["default"].sign({ new_user: new_Employee }, secToken);
                console.log(token);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, users.authenticate(checkUser.username, checkUser.user_password)];
            case 1:
                checkAuth = _a.sent();
...
var store_userss_routes = function (app) {
