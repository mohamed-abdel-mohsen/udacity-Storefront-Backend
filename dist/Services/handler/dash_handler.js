...
var dash_model_1 = require("../model/dash_model");
dotenv_1["default"].config();
var dashboard = new dash_model_1.DashboardQueries();
var OrdersByUsers = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.OrdersToUsers()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
